...
```bash
npm i @fluid-experimental/directory-tree
```

## API Documentation

API documentation for **@fluid-experimental/directory-tree** is available at <https://fluidframework.com/docs/apis/directory-tree>.
